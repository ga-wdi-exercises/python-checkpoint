...
class Motorcycle(Vehicle):
  def __init__(self, dict, wheel_count = 'no wheels'):
    super().__init__(dict)

  def pop_wheelie(self, wheel_count = 'no wheels!'):
...
class Car(Vehicle):
    def can_drive(self, wheel_count = 4):
      return 'Vrrooooom Vroooom'
      
 # ?! Don't need. All props are inherited, only defined method.
